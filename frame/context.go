...
type Context interface {
	...
	//Monitorf(fmt string, args ...interface{})
...
//// Error default error
//func (c *icecontext) Monitor(args ...interface{}) {
//	log.Default().FormatAndOutput(4, log.MONITOR, "", c.appendBiz(args)...)
//}
...
//// Monitor monitor log
//func (c *icecontext) Monitorf(fmt string, args ...interface{}) {
//	fmt, args = c.appendf(fmt, args)
//	log.Default().FormatAndOutput(4, log.MONITOR, fmt, args...)
//}
